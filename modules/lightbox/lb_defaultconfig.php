...
global $mediatab,$LB_AL_HEAD_LINKS,$LB_AL_THUMB_LINKS,$LB_ML_THUMB_LINKS,$LB_SS_SPEED, $gBitDb;
global $LB_MUSIC_FILE,$LB_TRANSITION,$LB_URL_WIDTH,$LB_URL_HEIGHT,$GEDCOM;

// Create LB tables, if not already present
try {
//	$gBitDb->updateSchema('./modules/lightbox/db_schema/', 'LB_SCHEMA_VERSION', 1);
