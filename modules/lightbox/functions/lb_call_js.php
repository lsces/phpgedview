...
?>
<?php if ($TEXT_DIRECTION == "rtl") { ?>
		<script src="modules/lightbox/js/Sound.js"></script>
		<script src="modules/lightbox/js/clearbox.js"></script>
		<!--[if lte IE 7]>
...
<?php  } ?>
		...
		<script src="modules/lightbox/js/wz_tooltip.js"></script>
		<script src="modules/lightbox/js/tip_centerwindow.js"></script>
		<?php if ($TEXT_DIRECTION=="rtl") { ?>
			<script src="modules/lightbox/js/tip_balloon_RTL.js"></script>
		<?php }else{ ?>
			<script src="modules/lightbox/js/tip_balloon.js"></script>
		<?php } ?>
