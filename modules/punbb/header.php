...
if (defined('PUN_ADMIN_CONSOLE'))
	...
	$tpl_main = ( defined( 'PUN_HELP' ) ) ? file_get_contents( PUN_ROOT . 'include/template/help.tpl' ) : file_get_contents( PUN_ROOT . 'include/template/main.tpl' );
...
if (strpos($user_agent, 'msie') !== false && strpos($user_agent, 'windows') !== false && strpos($user_agent, 'opera') === false)
	echo '<script src="'.PUN_ROOT.'style/imports/minmax.js"></script>';
