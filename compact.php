...
$cellwidth = ( strlen( $name ) < 30 ) ? "420" : ( strlen( $name ) * 14 );
14;
...
print_arrow_person( 16, "up" );
print "</td>";
print "<td></td>";
print "<td></td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 18, "up" );
print "</td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 24, "up" );
print "</td>";
print "<td></td>";
print "<td></td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 26, "up" );
print "</td>";
print "</tr>";
...
print_td_person( 8 );
print "<td style='text-align:center;'>";
print_arrow_person( 8, "left" );
print "</td>";
print_td_person( 4 );
print "<td style='text-align:center;'>";
print_arrow_person( 9, "right" );
print "</td>";
print_td_person( 9 );
print "<td></td>";
print_td_person( 12 );
print "<td style='text-align:center;'>";
print_arrow_person( 12, "left" );
print "</td>";
print_td_person( 6 );
print "<td style='text-align:center;'>";
print_arrow_person( 13, "right" );
print "</td>";
print_td_person( 13 );
print "</tr>";
...
print "<tr>";
print "<td style='text-align:center;'>";
print_arrow_person( 17, "down" );
print "</td>";
print "<td rowspan='3' colspan='3' style='text-align:center;'>";
print_arrow_person( 4, "up" );
print "</td>";
print "<td style='text-align:center;'>";
print_arrow_person( 19, "down" );
print "</td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 25, "down" );
print "</td>";
print "<td rowspan='3' colspan='3' style='text-align:center;'>";
print_arrow_person( 6, "up" );
print "</td>";
print "<td style='text-align:center;'>";
print_arrow_person( 27, "down" );
print "</td>";
print "</tr>";
...
print "<td style='text-align:center;' width='25%'>";
print_arrow_person( 2, "left" );
print "</td>";
print_td_person( 1 );
print "<td style='text-align:center;' width='25%'>";
print_arrow_person( 3, "right" );
print "</td>";
print "</tr></table>";
print "</td>";
...
print "<td>&nbsp;</td>";
print "<td rowspan='3' colspan='3' style='text-align:center;'>";
print_arrow_person( 5, "down" );
print "</td>";
print "<td></td>";
print "<td></td>";
print "<td></td>";
print "<td rowspan='3' colspan='3' style='text-align:center;'>";
print_arrow_person( 7, "down" );
print "</td>";
print "<td></td>";
print "</tr>";
...
print "<tr>";
print "<td style='text-align:center;'>";
print_arrow_person( 20, "up" );
print "</td>";
print "<td style='text-align:center;'>";
print_arrow_person( 22, "up" );
print "</td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 28, "up" );
print "</td>";
print "<td style='text-align:center;'>";
print_arrow_person( 30, "up" );
print "</td>";
print "</tr>";
...
print_td_person( 10 );
print "<td style='text-align:center;'>";
print_arrow_person( 10, "left" );
print "</td>";
print_td_person( 5 );
print "<td style='text-align:center;'>";
print_arrow_person( 11, "right" );
print "</td>";
print_td_person( 11 );
print "<td></td>";
print_td_person( 14 );
print "<td style='text-align:center;'>";
print_arrow_person( 14, "left" );
print "</td>";
print_td_person( 7 );
print "<td style='text-align:center;'>";
print_arrow_person( 15, "right" );
print "</td>";
print_td_person( 15 );
print "</tr>";
...
print "<tr>";
print "<td style='text-align:center;'>";
print_arrow_person( 21, "down" );
print "</td>";
print "<td></td>";
print "<td></td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 23, "down" );
print "</td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 29, "down" );
print "</td>";
print "<td></td>";
print "<td></td>";
print "<td></td>";
print "<td style='text-align:center;'>";
print_arrow_person( 31, "down" );
print "</td>";
print "</tr>";
