...
$PGV_BLOCKS["print_user_favorites"]["config"]		= [ "cache" => 0 ];

//-- print user favorites
function print_user_favorites($block=true, $config="", $side='', $index='') {
	global $pgv_lang, $PGV_IMAGE_DIR, $PGV_IMAGES, $GEDCOM, $TEXT_DIRECTION, $MEDIA_DIRECTORY, $MULTI_MEDIA, $MEDIA_DIRECTORY_LEVELS, $ctype;
	...
	$content = $ENABLE_AUTOCOMPLETE 
		? '<script src="js/jquery/jquery.min.js"></script>
			<script src="js/jquery/jquery.autocomplete.js"></script>
			<script src="js/jquery/jquery.ajaxQueue.js"></script>
			<script>
