...
$pgv_lang["tradition_none"]		= "Ei perinnettä";
...
$pgv_lang["config.php_not_writable"]		= "config.php tiedostoon ei voi kirjoittaa.";
...
$pgv_lang["module_admin"]			= "Moduulin ylläpito";
$pgv_lang["mod_admin_installed"]	= "Asennetut moduulit";
$pgv_lang["mod_admin_tabs"]			= "Hallitse välilehtiä";
$pgv_lang["mod_admin_menus"]		= "Hallitse valikkoja";
$pgv_lang["mod_admin_intro"]		= "Alla on lista kaikista tälle PhpGedView sivustolle asennetuista moduuleista. Moduulit asennetaan sijoittamalla ne <i>modules</i> hakemistoon. Täällä voit asettaa GEDCOM-tiedostokohtaisesti pääsyn kullekin moduulille. Jos moduuli sisältää välilehtiä yksittäisille sivuille tai valikkoja päävalikkoon, voit myös asettaa pääsyn ja järjestyksen kullekin niistä.";
$pgv_lang["mod_admin_active"]		= "Käytössä";
$pgv_lang["mod_admin_name"]			= "Moduulin nimi";
$pgv_lang["mod_admin_description"]	= "Kuvaus";
$pgv_lang["mod_admin_version"]		= "Versio / PGV";
$pgv_lang["mod_admin_hastab"]		= "Välilehti?";
$pgv_lang["mod_admin_hasmenu"]		= "Valikko?";
$pgv_lang["mod_admin_access_level"]	= "Pääsy";
$pgv_lang["mod_admin_order"]		= "Järjestys";
$pgv_lang["mod_admin_config"]		= "Moduulin asetukset";
$pgv_lang["mod_admin_settings"]		= "Moduulin asetukset";
$pgv_lang["ret_module_admin"]		= "Palaa moduulin ylläpitosivulle";
$pgv_lang["ret_admin"]				= "Palaa ylläpitosivulle";
?>
