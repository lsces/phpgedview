...
$pgv_lang["INDEX_DIRECTORY_help"]       = "~#pgv_lang[INDEX_DIRECTORY]#~<r /><br />Sökvägen till den katalog med läs och skrivrättigheter som PhpGedView skall använda för att lagra indexfiler (inkludera avslutande \"/\")<br />Detta ställer in variabeln \PHPGEDVIEW_PKG_INDEX_PATH  i filen <i>config.php</i>.<br />";
...
$pgv_lang["SUBLIST_TRIGGER_I_help"]	= "~#pgv_lang[SUBLIST_TRIGGER_I]#~<br /><br />Långa listor av personer med samma efternamn kan brytas upp till mindre underlistor efter första bokstaven i personen förnamn.<br /><br />Detta val bestämmer när underlistor av efternamn ska skapas. För att stänga av detta val helt, sätt detta val till noll.<br />";
$pgv_lang["SUBLIST_TRIGGER_F"]		= "Maximalt antal familjenamn";
$pgv_lang["SUBLIST_TRIGGER_F_help"]	= "~#pgv_lang[SUBLIST_TRIGGER_F]#~<br /><br />Långa listor av familjer med samma efternamn kan brytas upp till mindre underlistor efter första bokstaven i personen förnamn.<br /><br />Detta val bestämmer när underlistor av familjenamn ska skapas. För att stänga av detta val helt, sätt detta val till noll.<br />";
...
$pgv_lang["MEDIA_DIRECTORY_help"]       = "~#pgv_lang[MEDIA_DIRECTORY]#~<br /><br />Sökvägen till den katalog där PhpGedView skall leta efter lokala multimediafiler (inkludera avslutande \"/\"). PhpGedView kräver inte att denna mapp heter \"media\". Du kan välj vilket namn du vill.<br /><br />För ökad säkerhet bör denna mapp placeras någonstans på servern som inte är åtkomligt från internet. Ett exempel på en sådan struktur kommer här:<br />><b>PhpGedView:</b> dir1/dir2/dir3/PhpGedView<br /><b>Media:</b> dir1/dir4/dir5/dir6/media<br /><br />För det visade exemplet skall du skriva  <b>../../dir4/dir5/dir6/media/</b> i detta fält.<br />";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "~#pgv_lang[SHOW_LIVING_NAMES]#~<br /><br />Skall levande personers namn visas för allmänheten?<br />";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Visa forskningsassistenten";
$pgv_lang["SHOW_RESEARCH_ASSISTANT_help"]		= "~#pgv_lang[SHOW_RESEARCH_ASSISTANT]#~<br /><br />Vilken typ av användare kan se forskningsassistentmodulen om den är installerad?<br />";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "~#pgv_lang[USE_RELATIONSHIP_PRIVACY]#~<br /><br />Ett <b>Nej'</b>innebär att registrerade användare kan se detaljerna på alla levande personer.<br /><br />Ett <b>Ja</b> betyder att användare bara kan se den privata informationen för levande personer de är släkt med.<br />";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "~#pgv_lang[MAX_RELATION_PATH_LENGTH]#~<br /><br />Om #pgv_lang[USE_RELATIONSHIP_PRIVACY]# är påsatt, inloggade användare kommer endast kunna se och redigera personer inom detta antal släktsteg.<br />";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "~#pgv_lang[CHECK_MARRIAGE_RELATIONS]#~<br /><br />Kontrollera släktförhållande genom vigselrelationer.<br />";
...
$pgv_lang["week_start_help"]			= "~#pgv_lang[week_start]#~<br /><br />Veckodagen som veckan startar på i detta språk. I Sverige räknar vi vanligen måndag som första veckodagen.<br />";
$pgv_lang["name_reverse"]				= "Efternamn först";
$pgv_lang["name_reverse_help"]			= "~#pgv_lang[name_reverse]#~<br /><br />På några språk skall efternamnet visas först istället för standardinställningen att visa det sist. Om du aktiverar detta val kommer efternamnet att visas först.<br />";
...
$pgv_lang["alphabet_upper_help"]		= "~#pgv_lang[alphabet_upper]#~<br /><br />Stora bokstäver i detta språk. Detta alfabet används för sortering av namn med stora bokstäver i namnlistorna.<br />";
$pgv_lang["alphabet_lower"]				= "Små bokstäver";
$pgv_lang["alphabet_lower_help"]		= "~#pgv_lang[alphabet_lower]#~<br /><br />Små bokstäver i detta språk. Detta alfabet används för sortering av små bokstäver i namnlistorna.<br />";
...
$pgv_lang["INDI_FACTS_QUICK_help"]	= "~#pgv_lang[INDI_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM personfakta som visas intill den fulla listan och som kan läggas till med ett klick.<br />";
...
$pgv_lang["FAM_FACTS_QUICK_help"]	= "~#pgv_lang[FAM_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM familjefakta som visas intill den fulla listan och som kan läggas till med ett klick.<br />";
...
$pgv_lang["SOUR_FACTS_QUICK_help"]	= "~#pgv_lang[SOUR_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM källfakta som visas intill den fulla listan och som kan läggas till med ett klick.<br />";
...
$pgv_lang["REPO_FACTS_QUICK_help"]	= "~#pgv_lang[REPO_FACTS_QUICK]#~<br /><br />Detta är den korta listan av GEDCOM arkivfakta som visas intill den fulla listan och som kan läggas till med ett klick.<br />";
...
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "~#pgv_lang[SHOW_NO_WATERMARK]#~<br /><br />Om mediabrandväggen är på kommer användarna att se vattenmärke om de inte har den rättighetsnivå som specificeras här.<br /><br />";
...
$pgv_lang["USE_MEDIA_VIEWER_help"]		= "~#pgv_lang[USE_MEDIA_VIEWER]#~<br /><br />Med detta värde satt till <b>Ja</b>, när användare klickar på en bild på din sajt kommer de att kommat till mediavisningssidan som introduceras i v4.1. Mediavisningssidan visar detaljer om en bild och låter dig ändra detaljer om bilden.<br /><br />Satt till <b>Nej</b> kommer att ge det gamla beteendet från PhpGedView-versioner tidigare än v4.1 där genom att klicka på en bild öppnar den fullt upplösta bilden i nytt fönster.<br /><br />";
$pgv_lang["USE_MEDIA_FIREWALL"]			= "Använd mediabrandvägg";
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />Läs på Wikin för en beskrivning på hur du ska använda mediabrandväggen. <a href=\"http://wiki.phpgedview.net/en/index.php/Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php/Media_Firewall</a><br /><br />";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Mediabrandväggens rootmapp";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~#pgv_lang[MEDIA_FIREWALL_ROOTDIR]#~<br /><br />Mapp i vilken den skyddade mediamappen kan skapas. När detta fält är tomt, kommer <b>#GLOBALS[INDEX_DIRECTORY]#</b> mappen att användas.<br /><br />";
