...
$pgv_lang["DEFAULT_GEDCOM"]						= "选择家谱";
$pgv_lang["default_user"]						= "创造管理用户";
$pgv_lang["del_proceed"]						= "继续";
$pgv_lang["del_unvera"]							= "用户没有被管理员确认";
$pgv_lang["del_unveru"]							= "用户在七天内没有确认";
...
$pgv_lang["import_marr_names"]					= "计算婚后名字";
$pgv_lang["import_options"]						= "读入选项";
$pgv_lang["import_progress"]					= "正在倒入...";
$pgv_lang["import_statistics"]					= "导入统计";
$pgv_lang["inc_languages"]						= "语言";
$pgv_lang["INDEX_DIRECTORY"]					= "工作文件夹";
...
$pgv_lang["last_login"]							= "上次登陆";
$pgv_lang["link_manage_servers"]   				= "管理网站";
$pgv_lang["logfile_content"]					= "看电脑日记文件";
$pgv_lang["mailto"]								= "发电邮件";
...
$pgv_lang["SERVER_URL"]							= "家谱网络地址";
$pgv_lang["show_phpinfo"]		= "显示PHP信息";
$pgv_lang["siteadmin"]							= "网页管理员";
$pgv_lang["time_limit"]							= "时限：";
$pgv_lang["translator_tools"]					= "翻译工具";
$pgv_lang["update_myaccount"]					= "更新用户帐号信息";
$pgv_lang["update_user"]		= "更新用戶";
$pgv_lang["upload_gedcom"]		= "上载的家谱文件";
$pgv_lang["USE_REGISTRATION_MODULE"]			= "允许客人申请注册";
$pgv_lang["user_auto_accept"]					= "自动接受用户的更改变化";
$pgv_lang["user_contact_method"]				= "理想的联系方法";
...
$pgv_lang["users_unver"]						= "没有确认的用户";
$pgv_lang["users_unver_admin"]					= "没有被管理员确认";
$pgv_lang["usr_deleted"]						= "删除用户：";
$pgv_lang["verified"]			= "User verified himself:";
$pgv_lang["verified_by_admin"]		= "用户被管理员接受";
$pgv_lang["verify_gedcom"]						= "确认家谱文件";
$pgv_lang["visitor"]							= "客人";
$pgv_lang["weekly"]								= "每周";
$pgv_lang["welcome_new"]						= "欢迎来到你的家谱网站。";
$pgv_lang["yearly"]								= "每年";
$pgv_lang["admin_OK_subject"]					= "允许账户在 #SERVER_NAME#";
$pgv_lang["gedcheck"]     = "家谱文件测验";
$pgv_lang["level"]        = "层次";                   
$pgv_lang["error"]        = "出错";
$pgv_lang["warning"]      = "警告";
$pgv_lang["info"]         = "信息";
