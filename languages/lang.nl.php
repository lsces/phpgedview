...
$pgv_lang["begins_with"]			= "Begint met";
$pgv_lang["contains"]					= "Bevat";
$pgv_lang["sounds_like"]			= "Klinkt als";
$pgv_lang["advanced_search"] 		= "Uitgebreid zoeken";
$pgv_lang["more_fields"]			= "Meer velden toevoegen";
$pgv_lang["install_step_8"] 		= "Beginnen";
$pgv_lang["parent_family"]			= "Ouders familie";
$pgv_lang["step_parent_family"]		= "Stiefouders familie";
$pgv_lang["immediate_family"]		= "Directe familie";

$pgv_lang["load_full_tree"]			= "Bekjk deze boom op een volledige pagina, als interactieve boom";
$pgv_lang["hide_show_spouses"]		= "Toon of verberg meerdere echtgenoten";
$pgv_lang["interactive_tree"]		= "Interactieve stamboom";
$pgv_lang["example"]					= "Voorbeeld:";
$pgv_lang["tree"]					= "Boom";
$pgv_lang["ellipsis"]					= "\xE2\x80\xA6";
$pgv_lang["showUnknown"]			= "Toon geslacht onbekend";
$pgv_lang["count"]						= "Tel";
$pgv_lang["age_differences"]		= "Toon datum verschillen";
$pgv_lang["multi_site_search"] 		= "Meerdere sites doorzoeken";
$pgv_lang["switch_lifespan"]		= "Toon levensduur grafiek";
$pgv_lang["switch_timeline"]		= "Toon tijdlijn grafiek";
$pgv_lang["differences"]				= "Verschillen";
$pgv_lang["charts_block"]			= "Grafiek Blok";
$pgv_lang["charts_block_descr"]			= "Het Grafiek Blok laat u een grafiek op de Welkom of uw MyGedView portal pagina.  U kunt het blok instellen om een nakomelingen-, voorouder-, of zandloper grafiek te tonen. U kunt de startpersoon voor deze grafiek instellen.";
$pgv_lang["charts_click_box"]			= "Klik op een naam, om meer informatie over die persoon zichtbaar te maken.";
$pgv_lang["chart_type"]					= "Grafiek Type";
$pgv_lang["changedate1"]			= "Einddatum van lijst met wijzigingen";
...
$pgv_lang["lchildren"]				= "kinderen";
$pgv_lang["child"]						= "Kind";
$pgv_lang["grandchildren"]			= "kleinkinderen";
$pgv_lang["family"]						= "Gezin";
$pgv_lang["as_child"]				= "Gezin met ouders";
$pgv_lang["shared_note_menu"]		= "Opties voor gedeelde notities";
$pgv_lang["source_menu"]			= "Opties voor bron";
$pgv_lang["repo_menu"]				= "Opties voor bewaarplaats";
...
$pgv_lang["clipping_privacy"]			= "Sommige items konden niet worden toegevoegd, vanwege privacy restricties";
$pgv_lang["chart_new"]					= "Familie boom grafiek";
$pgv_lang["loading"]				= "Laden...";
$pgv_lang["clear_chart"]				= "Wis Grafiek";
$pgv_lang["file_information"]			= "Bestands Informatie";
$pgv_lang["choose_file_type"]			= "Kies Bestands Type";
$pgv_lang["add_individual_by_id"]	= "Voeg persoon toe d.m.v. ID";
$pgv_lang["advanced_options"]		= "Uitgebreide opties";
$pgv_lang["zip_files"]				= "Zip bestand(en)";
$pgv_lang["include_media"]			= "Inclusief Media (automatische zips bestanden)";
$pgv_lang["roman_surn"]				= "Geromaniseerde achternaam";
$pgv_lang["roman_givn"]				= "Geromaniseerde voornamen";
$pgv_lang["include"]				= "Inclusief:";
$pgv_lang["page_x_of_y"]			= "Pagina #GLOBALS[currentPage]# van #GLOBALS[lastPage]#";
$pgv_lang["options"]				= "Opties:";
$pgv_lang["config_update_ok"]			= "Configuratie bestand met succes bijgewerkt.";
$pgv_lang["page_size"]				= "Paginaformaat";
$pgv_lang["font"]						= "Lettertype";
$pgv_lang["use_colors"]				= "Gebruik kleuren";
...
$pgv_lang["stat_avg_age_at_death"]	= "Gemid. leeftijd bij overlijden";
...
$pgv_lang["stat_media"]				= "Media objecten";
...
$pgv_lang["stat_males"]				= "mannen";
$pgv_lang["stat_females"]			= "vrouwen";
$pgv_lang["stat_unknown"]			= "onbekend";
$pgv_lang["stat_link"]				= "Bekijk statistieken als grafiek";
$pgv_lang["print_stat_link"]		= "Toon link naar Statistische overzichten?";
...
$pgv_lang["htmlplus_block_narrative"] 	= "Verhalende stijl (alleen in het Engels)";
$pgv_lang["htmlplus_block_custom"]		= "Aangepast";
$pgv_lang["htmlplus_block_keyword"]		= "Voorbeelden trefwoord (alleen in het Engels)";
$pgv_lang["htmlplus_block_taglist"]		= "Tag Lijst";
$pgv_lang["htmlplus_block_compat"]		= "Compatibiliteit Mode";
$pgv_lang["htmlplus_block_ui"]			= "Uitgebreide Interface";
$pgv_lang["htmlplus_block_current"]		= "Huidig";
$pgv_lang["htmlplus_block_default"]		= "Standaard";
$pgv_lang["htmlplus_block_gedcom"]		= "Familie Boom";
$pgv_lang["htmlplus_block_birth"]		= "geboorte";
$pgv_lang["htmlplus_block_death"]		= "overlijden";
$pgv_lang["htmlplus_block_marrage"]		= "huwelijk";
$pgv_lang["htmlplus_block_adoption"]	= "adoptie";
$pgv_lang["htmlplus_block_burial"]		= "begrafenis";
$pgv_lang["htmlplus_block_census"]		= "census toegevoegd";
...
$pgv_lang["first_letter_name"]			= "Kies een letter om gezinnen te tonen waarvan de naam begint met die letter.";
$pgv_lang["first_letter_sfname"]		= "Kies een letter om gezinnen te tonen, waarvan een van de partners een voornaam heeft welke met die letter begint.";
$pgv_lang["first_letter_iname"]			= "Kies een letter om personen te tonen wiens achternaam begint met die letter.";
$pgv_lang["first_letter_fname"]			= "Kies een letter om families te tonen wiens naam begint met die letter.";
$pgv_lang["total_names"]			= "Totaal aantal namen";
$pgv_lang["total_changes"]			= "Totaal aantal wijzigigen";
$pgv_lang["total_links"]			= "Totaal aantal links";
...
$pgv_lang["show_pending"]			= "Toon lopende wijzigingen";
...
$pgv_lang["stepparent"]				= "Stiefouder";
...
$pgv_lang["rootid"] 				= "Startpersoon v.d. Kwartierstaat";
...
$pgv_lang["landscape_top"]			= "Oudste bovenaan";
$pgv_lang["landscape_down"]			= "Oudste onderaan";
...
$pgv_lang["random_surn"]			= "Willekeurige achternaam";
$pgv_lang["generation_number"]			= "Generaties";
...
$pgv_lang["branch_list"]				= "Takken";
$pgv_lang["source_list"]			= "Bronnen";
$pgv_lang["shared_note_list"]		= "Gedeelde notities";
...
$pgv_lang["male"]					= "Man";
$pgv_lang["males"]					= "Mannen";
$pgv_lang["female"]						= "Vrouw";
$pgv_lang["females"]					= "Vrouwen";
$pgv_lang["temple"]					= "HLD tempel";
$pgv_lang["temple_code"]			= "HLD Tempelcode:";
...
$pgv_lang["show_fact_sources"]		= "Toon alle bronnen";
$pgv_lang["show_fact_notes"]		= "Toon alle notities";
...
$pgv_lang["which_s_links"]			= "Welke kaarten, die aan deze bron zijn gekoppeld, moeten worden toegevoegd?";
$pgv_lang["just_source"]			= "Aleen deze bron toevoegen.";
$pgv_lang["linked_source"]			= "Voeg deze bron toe en de families/mensen, die daaraan zijn gekoppeld.";
...
$pgv_lang["media_private"] 			= "Details over deze media zijn privé. Media details worden niet bijgevoegd.";
...
$pgv_lang["enter_person_generations"] 	= "Aantal generaties:";
$pgv_lang["convertPath"]				= "Converteer media pad naar";
$pgv_lang["convertSlashes"]				= "Converteer media map separators naar";
$pgv_lang["forwardSlashes"]				= "Slashes : /";
...
$pgv_lang["shared_notes"]			= "Gedeelde notities";
...
$pgv_lang["search_record"]			= "Gehele bestand";
$pgv_lang["search_to"]				= "tot";
...
$pgv_lang["repository"] 			= "Bewaarplaats";
...
$pgv_lang["shared_note"]			= "Gedeelde Notitie";
$pgv_lang["shared_notes_found"]		= "Gedeelde Notitie gevonden";
$pgv_lang["find_shared_note"]			= "Zoek Gedeelde Notitie";
$pgv_lang["shared_note_info"]		= "Informatie Gedeelde Notitie";
$pgv_lang["total_shared_notes"]		= "Aantal Gedeelde Notities";
...
$pgv_lang["apply_filter"]			= "Filter toepassen";
...
$pgv_lang["skip_marnms"]			= "Huwelijksnamen niet inbegrepen";
$pgv_lang["show_marnms"]			= "Huwelijksnamen inbegrepen";
$pgv_lang["all"]					= "ALLE";
...
$pgv_lang["roots"]		 			= "Wortels";
$pgv_lang["leaves"] 				= "Takken";
$pgv_lang["widow"] 					= "Weduwe";
$pgv_lang["widower"] 				= "Weduwenaar";
$pgv_lang["show_parents"] 			= "Toon ouders";

//-- TIMELINE FILE MESSAGES
$pgv_lang["age"]					= "Leeftijd";
$pgv_lang["husb_age"]				= "leeftijd echtgenoot";
$pgv_lang["wife_age"]				= "leeftijd vrouw";
$pgv_lang["year1"]					= "jaar";
$pgv_lang["years2"]					= "jaren";	// 2 years
...
$pgv_lang["timeline_endYear"] 		= "Einde Jaar";
$pgv_lang["timeline_scrollSpeed"] 	= "Snelheid";
...
$pgv_lang["basic_realm"]			= "PhpGedView Authorisatie Systeem";
...
$pgv_lang["media_dir_2"]			= "Dit media object staat in de standaard media map";
$pgv_lang["media_dir_3"]			= "Dit media object staat in de beschermde media map";
$pgv_lang["thumb_dir_1"]			= "Deze miniatuur staat op een externe server";
$pgv_lang["thumb_dir_2"]			= "Deze miniatuur staat in de standaard media map";
$pgv_lang["thumb_dir_3"]			= "Deze miniatuur staat in de beschermde media map";
$pgv_lang["moveto_2"]				= "Verplaats naar de beschermde map";
$pgv_lang["moveto_3"]				= "Verplaats naar de standaard map";
$pgv_lang["move_standard"]			= "Verplaats naar standaard";
$pgv_lang["move_protected"]			= "Verplaats naar beschermd";
$pgv_lang["move_mediadirs"]			= "Verplaats Media mappen";
$pgv_lang["setperms"]				= "Stel Media Permissies in";
$pgv_lang["setperms_fix"]			= "Correct lees/schrijf/uitvoeren permissies";
$pgv_lang["setperms_success"]		= "Permissies Ingesteld";
$pgv_lang["setperms_failure"]		= "Permissies Niet Ingesteld";
$pgv_lang["setperms_time_exceeded"]	= "De uitvoerings-tijd-limiet was bereikt. Probeer het commando nogmaals op een kleinere map.";
$pgv_lang["move_time_exceeded"]		= "De uitvoerings-tijd-limiet was bereikt. Probeer het commando nogmaals om de rest van de bestanden te verplaatsen.";
$pgv_lang["media_firewall_rootdir_no_exist"]			= "De Media Firewall basis map, die u opgaf, bestaat niet.  U moet de map eerst maken.";
$pgv_lang["media_firewall_protected_dir_no_exist"]		= "De beschermde media map kon niet gemaakt worden in de Media Firewall basis map.  Maak a.u.b. deze map en maak het world-writable.";
$pgv_lang["media_firewall_protected_dir_not_writable"]	= "De beschermde media map, in de Media Firewall basis map, is niet world writable. ";
$pgv_lang["media_firewall_invalid_dir"]					= "FOUT: De Media Firewall was gestart vanuit een andere map dan de media map.";

//-- Relationship chart messages
$pgv_lang["view_fam_nav_details"]	= "Bekijk details betreffende ...";
$pgv_lang["view_fam_nav_notes"]		= "Bekijk notities betreffende ...";
$pgv_lang["view_fam_nav_sources"]	= "Bekijk bronnen betreffende ...";
$pgv_lang["view_fam_nav_media"]		= "Bekijk media betreffende ...";
$pgv_lang["view_fam_nav_album"]		= "Bekijk album betreffende ...";
$pgv_lang["view_fam_nav_relatives"]	= "Bekijk familie ...";
$pgv_lang["view_fam_nav_tree"]		= "Bekijk boom betreffende ...";
$pgv_lang["view_fam_nav_research"]	= "Bekijk onderzoek betreffende ...";
$pgv_lang["view_fam_nav_map"]		= "Bekijk kaart betreffende ...";
$pgv_lang["view_fam_nav_spare"]		= "Bekijk reserve-info betreffende ...";
$pgv_lang["navigator"]				= "Navigator";
$pgv_lang["fam_navigator"]				= "Gezinnen Navigator";
...
$pgv_lang["no_other_link_found"]	= "Er konden geen andere links tussen de twee personen worden gevonden.";
...
$pgv_lang["greatgrandchild"]		= "Achterkleinkind";
$pgv_lang["greatgrandson"]			= "Achterkleinzoon";
$pgv_lang["greatgranddaughter"]		= "Achterkleindochter";
$pgv_lang["brother"]					= "Broer";
$pgv_lang["sister"]					= "Zus";
$pgv_lang["aunt"]					= "Tante";
$pgv_lang["uncle"]					= "Oom";
$pgv_lang["nephew"]					= "Neef";
$pgv_lang["niece"]					= "Nicht";
...
// 1st generation
$pgv_lang["bosa_brothers_offspring_2"] 		= "neef";
$pgv_lang["bosa_brothers_offspring_3"] 		= "nicht";
// 2nd generation
$pgv_lang["bosa_brothers_offspring_4"] 		= "achterneef";
$pgv_lang["bosa_brothers_offspring_5"] 		= "achternicht";
$pgv_lang["bosa_brothers_offspring_6"] 		= "achterneef";
$pgv_lang["bosa_brothers_offspring_7"] 		= "achternicht";
...
// of generations just by adding more translations.
// 1st generation
$pgv_lang["bosa_sisters_offspring_2"] 		= "neef";
$pgv_lang["bosa_sisters_offspring_3"] 		= "nicht";
// 2nd generation
$pgv_lang["bosa_sisters_offspring_4"] 		= "achterneef";
$pgv_lang["bosa_sisters_offspring_5"] 		= "achternicht";
$pgv_lang["bosa_sisters_offspring_6"] 		= "achterneef";
$pgv_lang["bosa_sisters_offspring_7"] 		= "achternicht";
// for the general case of offspring of the nth generation use the text below
// in this text %1\$d is replaced with the number of generations
//              %2\$d is replaced with the number of generations - 1
//              %3\$d is replaced with the number of generations - 2
...
// of generations just by adding more translations.
// 1st generation
$pgv_lang["bosa_2"] 				= "Zoon";                   // son
$pgv_lang["bosa_3"] 				= "Dochter";              // daughter
// 2nd generation
$pgv_lang["bosa_4"] 				= "Kleinzoon";              // son's son
$pgv_lang["bosa_5"] 				= "Kleindochter";         // son's daughter
$pgv_lang["bosa_6"] 				= "Kleinzoon";              // daughter's son
$pgv_lang["bosa_7"] 				= "Kleindochter";         // daughter's daughter
// 3rd generation
$pgv_lang["bosa_8"] 				= "achterkleinzoon";
$pgv_lang["bosa_9"] 				= "achterkleindochter";
$pgv_lang["bosa_10"] 				= "achterkleinzoon";
$pgv_lang["bosa_11"] 				= "achterkleindochter";
$pgv_lang["bosa_12"] 				= "achterkleinzoon";
$pgv_lang["bosa_13"] 				= "achterkleindochter";
$pgv_lang["bosa_14"] 				= "achterkleinzoon";
$pgv_lang["bosa_15"] 				= "achterkleindochter";
// for the general case of offspring of the nth generation use the text below
// in this text %1\$d is replaced with the number of generations
//              %2\$d is replaced with the number of generations - 1
//              %3\$d is replaced with the number of generations - 2
...
$pgv_lang["sosa_uncle_5"] 			= "oud-oom";
$pgv_lang["sosa_uncle_6"] 			= "oud-oom";
$pgv_lang["sosa_uncle_7"] 			= "oud-oom";
...
// 2nd generation
$pgv_lang["sosa_aunt_4"] 			= "oud-tante";
$pgv_lang["sosa_aunt_5"] 			= "oud-tante";
$pgv_lang["sosa_aunt_6"] 			= "oud-tante";
$pgv_lang["sosa_aunt_7"] 			= "oud-tante";
...
// aunts and uncles
// 1st generation
$pgv_lang["sosa_uncle_bm_2"] 		= "Oom";            // father's brother
$pgv_lang["sosa_uncle_bm_3"] 		= "Oom";            // mother's brother
// 2nd generation
$pgv_lang["sosa_uncle_bm_4"] 		= "oud-oom";
$pgv_lang["sosa_uncle_bm_5"] 		= "oud-oom";
$pgv_lang["sosa_uncle_bm_6"] 		= "oud-oom";
$pgv_lang["sosa_uncle_bm_7"] 		= "oud-oom";
// for the general case of uncles of the nth degree use the text below
// in this text %1\$d is replaced with the number of generations
//              %2\$d is replaced with the number of generations - 1
//              %3\$d is replaced with the number of generations - 2
...
$pgv_lang["anniversary"]			= "Jaarlijkse gebeurtenis";
...
$pgv_lang["style"]					= "Presentatie Stijl";
$pgv_lang["style1"]					= "Lijst";
$pgv_lang["style2"]					= "Tabel";
$pgv_lang["style3"]					= "Tag-wolkje";
$pgv_lang["sort_style"]				= "Sorteer Methode";
$pgv_lang["by_anniv"]				= "Op Verjaardag";
$pgv_lang["by_alpha"]				= "Alphabetisch";
$pgv_lang["cal_download"]			= "Kalendar gebeurtenissen downloaden toestaan?";
...
$pgv_lang["ahnentafel_born_m"]		= "werd geboren";		// male
$pgv_lang["ahnentafel_born_f"]		= "werd geboren";		// female
$pgv_lang["ahnentafel_christened_m"]= "werd gedoopt";		// male
$pgv_lang["ahnentafel_christened_f"]= "werd gedoopt";		// female
$pgv_lang["ahnentafel_married_m"]	= "is getrouwd met";	// male
$pgv_lang["ahnentafel_married_f"]	= "is getrouwd met";	// female
$pgv_lang["ahnentafel_married_post"]= "&nbsp;";
$pgv_lang["ahnentafel_died_m"]		= "overleed";			// male
$pgv_lang["ahnentafel_died_f"]		= "overleed";			// female
$pgv_lang["ahnentafel_cremated_m"]	= "werd gecremeerd";	// male
$pgv_lang["ahnentafel_cremated_f"]	= "werd gecremeerd";	// female
$pgv_lang["ahnentafel_buried_m"]	= "werd begraven";		// male
$pgv_lang["ahnentafel_buried_f"]	= "werd begraven";		// female
$pgv_lang["ahnentafel_place"]		= " in ";
$pgv_lang["ahnentafel_no_details"]	= " maar de details zijn onbekend";
$pgv_lang["ahnentafel_on"]			= " ";

//-- Changes report
$pgv_lang["changes_report"]			= "Wijzigingen Rapport";
$pgv_lang["changes_pending_tot"]	= "Totaal lopende wijzigingen: ";
$pgv_lang["changes_accepted_tot"]	= "Totaal goedgekeurde wijzigingen: ";

//-- Descendancy report
$pgv_lang["descend_report"]				= "Nakomelingen";
$pgv_lang["descendancy_header"]			= "Nakomelingen rapport voor ";
$pgv_lang["son_of"]					= "zoon van";
$pgv_lang["daughter_of"]				= "dochter van";
$pgv_lang["child_of"]					= "Kind van ";
$pgv_lang["children_of"]				= "Kinderen van ";
$pgv_lang["descendancy_pronoun_m"]		= "Hij ";
$pgv_lang["descendancy_pronoun_f"]		= "Zij ";
...
$pgv_lang["relatives_report_ext"]	= "Uitgebreid Verwanten Rapport";
$pgv_lang["with"]					= "met";
$pgv_lang["on"]						= "op";
$pgv_lang["in"]						= "in";
$pgv_lang["individual_report"]			= "Persoon";
$pgv_lang["individual_with_rela_report"]	= "Nauwe Verwanten Rapport";
...
$pgv_lang["cemetery_report"]		= "Begraafplaatsen Rapport";
$pgv_lang["burialplace"]			= "Begraafplaats bevat";
$pgv_lang["fact_sources_report"]		= "Bronnen van feiten";
$pgv_lang["missing_facts_report"]		= "Ontbrekende feiten v. verwanten";
$pgv_lang["sources_to_events"]		= "Bronnen v.d. gebeurtenissen";

$pgv_lang["cleanup"]					= "Opschonen";

//-- CONFIGURE (extra) messages for programs patriarch and statistics
$pgv_lang["statistics"]				= "Statistieken";
$pgv_lang["show_stats_charts"]		= "Toon statistieken grafieken";
$pgv_lang["decade_birth"]				= "Decade van Geboorte ";
$pgv_lang["decade_death"]				= "Decade van Overlijden";
$pgv_lang["decade_marriage"]			= "Decade van Huwelijk";
$pgv_lang["avg_age"]				= "Gemiddelde Leeftijd";
...
$pgv_lang["updated_favorites"] 		= "favorieten zijn bijgewerkt.";
...
$pgv_lang["employee"] 					= "Werknemer";
$pgv_lang["employer"] 					= "Werkgever";
$pgv_lang["foster_child"] 				= "Pleegkind";
$pgv_lang["foster_father"] 				= "Pleegvader";
$pgv_lang["foster_mother"] 				= "Pleegmoeder";
$pgv_lang["friend"]						= "Vriend(in)";
$pgv_lang["godfather"]				= "Peetoom";
$pgv_lang["godmother"]				= "Peettante";
$pgv_lang["godparent"]				= "Peet";
$pgv_lang["godson"]					= "Peetzoon";
$pgv_lang["goddaughter"] 			= "Peetdochter";
$pgv_lang["godchild"]				= "Petekind";
$pgv_lang["guardian"]				= "Voogd";
$pgv_lang["informant"]				= "Informant";
$pgv_lang["lodger"]					= "Kamerbewoner";
$pgv_lang["nanny"] 					= "Kinderjuffrouw";
$pgv_lang["nurse"]					= "Verpleegster";
$pgv_lang["owner"] 					= "Eigenaar";
...
$pgv_lang["with_sources"]			= "met bronnen";
$pgv_lang["without_sources"]		= "zonder bronnen";
$pgv_lang["stat_sindi"]				= "Personen met bronnen";
$pgv_lang["stat_sfam"]				= "Families met bronnen";
...
$pgv_lang["map_type"]				= "Type kaart";
$pgv_lang["stat_1_map"]				= "Individuele distributie";
$pgv_lang["stat_2_map"]				= "Geboorte per land";
$pgv_lang["stat_3_map"]				= "Sterfte per land";
$pgv_lang["stat_4_map"]				= "Huwelijk per land";
$pgv_lang["stat_5_birth"]			= "Geboorten per eeuw";
$pgv_lang["stat_6_death"]			= "Sterfgevallen per eeuw";
$pgv_lang["stat_7_marr"]			= "Huwelijken per eeuw";
$pgv_lang["stat_7_div"]				= "Scheidingen per eeuw";
$pgv_lang["stat_8_fam"]				= "Families met bronnen";
$pgv_lang["stat_9_indi"]			= "Personen met bronnen";
...
$pgv_lang["century"]				= "eeuw";
$pgv_lang["stat_age"]				= "Leeftijd";
$pgv_lang["no_date_fam"]			= "onbekend";
...
$pgv_lang["statar_xga"]				= "keuzewaarden voor aantallen (x-as):";
$pgv_lang["statar_zgp"]				= "grenswaarden voor perioden (z-as):";
$pgv_lang["less"]					= "jonger dan";
$pgv_lang["over"]					= "boven";
$pgv_lang["interval"]				= "interval";
$pgv_lang["aft_marr"]				= "maanden na huwelijk";
$pgv_lang["bef_marr"]				= "maanden voor en na huwelijk";
$pgv_lang["quarters"]				= "kwartaal na huwelijk";
$pgv_lang["half_year"]				= "half-jaar na huwelijk";
$pgv_lang["one_child"]				= "interval 1";
$pgv_lang["two_children"]			= "interval 2";
...
$pgv_lang["stat_marriages"]			= "Aantal huwelijken";
$pgv_lang["stat_divorces"]			= "Aantal scheidingen";
$pgv_lang["stat_deaths"]			= "Aantal sterfgevallen";
$pgv_lang["stat_first_birth"]		= "Vroegste geboorte";
$pgv_lang["stat_first_marriage"]	= "Vroegste huwelijk";
$pgv_lang["stat_first_divorce"]		= "Vroegste scheiding";
$pgv_lang["stat_first_death"]		= "Vroegste sterfgeval";
$pgv_lang["stat_last_birth"]		= "Laatste geboorte";
$pgv_lang["stat_last_marriage"]		= "Laatste huwelijk";
$pgv_lang["stat_last_divorce"]		= "Laatste scheiding";
$pgv_lang["stat_last_death"]		= "Laatste sterfgeval";
$pgv_lang["stat_lifespan"]			= "Levensverwachting";
$pgv_lang["stat_lived_longest"]		= "Hoogste leeftijd bij overlijden";
$pgv_lang["stat_live_longest"]		= "Oudste, nog levende, personen";
$pgv_lang["stat_marr_age"]			= "Duur van het huwelijk";
$pgv_lang["stat_long_marr_age"]		= "Langste huwelijk";
$pgv_lang["stat_short_marr_age"]	= "Kortste huwelijk";
$pgv_lang["stat_youngest_male"]		= "Jongste man";
$pgv_lang["stat_youngest_female"]	= "Jongste vrouw";
$pgv_lang["stat_oldest_male"]		= "Oudste man";
$pgv_lang["stat_oldest_female"]		= "Oudste vrouw";
$pgv_lang["stat_childbirth_age"]	= "Leeftijd bij geboorte kind";
$pgv_lang["stat_youngest_father"]	= "Jongste vader";
$pgv_lang["stat_youngest_mother"]	= "Jongste moeder";
$pgv_lang["stat_oldest_father"]		= "Oudste vader";
$pgv_lang["stat_oldest_mother"]		= "Oudste moeder";
$pgv_lang["stat_children_in_fam"]	= "Kinderen per gezin";
$pgv_lang["stat_largest_gfamilies"]	= "Grootste grootoudersgezinnen";
$pgv_lang["stat_age_difference"]	= "Leeftijd verschillen";
$pgv_lang["stat_age_siblings"]		= "Leeftijd verschil tussen nakomelingen";
$pgv_lang["stat_top_age_siblings"]	= "Grootste leeftijdsverschil tussen nakomelingen";
$pgv_lang["stat_age_mf_spouse"]		= "Leeftijd verschil tussen man en vrouw";
$pgv_lang["stat_age_fm_spouse"]		= "Leeftijd verschil tussen vrouw en man";
$pgv_lang["stat_names"]				= "Namen";
$pgv_lang["statnsurnames"]			= "Aantal achternamen";
$pgv_lang["statngivennames"]		= "Aantal voornamen";
$pgv_lang["top_surnames"]			= "Meest voorkomende achternamen";
$pgv_lang["top_givennames"]			= "Meest voorkomende voornamen";
$pgv_lang["events"]						= "Gebeurtenissen";
$pgv_lang["stat_records"]			= "Aantal items";
$pgv_lang["stat_notes"]				= "Notities";
$pgv_lang["stat_first_event"]		= "Eerste gebeurtenis";
$pgv_lang["stat_last_event"]		= "Laatste gebeurtenis";
$pgv_lang["stat_places"]			= "Plaatsen";
$pgv_lang["stat_birth_places"]		= "Geboorteplaatsen";
$pgv_lang["stat_marriage_places"]	= "Geboorteplaatsen";
$pgv_lang["stat_death_places"]		= "Plaatsen van overlijden";
$pgv_lang["stat_countries"]			= "Gebeurtenissen per land";

//-- statisticsplot utility
$pgv_lang["statistiek_list"]		= "Statistiek Grafiek";
$pgv_lang["stpl"]					= "...";
...
$pgv_lang["stplipot"]				= " / per tijdperiode";
$pgv_lang["stplmonth"]				= "maand";
$pgv_lang["stplnumbers"]			= "aantallen";
$pgv_lang["stplnuch"]				= "kinderen";
...
$pgv_lang["indi_distribution_chart"]	= "Verdeling per persoon";
$pgv_lang["surname_distribution_chart"]	= "Verdeling per achternaam";
$pgv_lang["g_chart_high"]			= "Hoogste Populatie";
$pgv_lang["g_chart_low"]			= "Laagste Populatie";
$pgv_lang["g_chart_nobody"]			= "Niemand";
$pgv_lang["area_chart"]				= "Geographisch gebied";
$pgv_lang["europe_chart"]				= "Europa";
$pgv_lang["s_america_chart"]		= "Zuid Amerika";
$pgv_lang["asia_chart"]				= "Azië";
$pgv_lang["middle_east_chart"]		= "Midden Oosten";
$pgv_lang["africa_chart"]			= "Afrika";
$pgv_lang["world_chart"]			= "Wereld";
...
$pgv_lang["both_alive"]					= "Beide in leven ";
$pgv_lang["both_dead"]					= "Beide overleden ";
...
$pgv_lang["shared_note_contains"]	= "Gedeelde Notitie bevat:";
...
$pgv_lang["add_faq_visibility"] 	= "FGV tonen voor:";
...
$pgv_lang["TYPE__coat"] 			= "Wapenschild (militair)";
...
$pgv_lang["TYPE__painting"] 		= "Schilderij";
$pgv_lang["TYPE__other"] 			= "Anders";

//-- Other media suff
$pgv_lang["view_slideshow"] 		= "Bekijk als diavoorstelling";
$pgv_lang["download_image"]				= "Download bestand";
$pgv_lang["no_media"]				= "Geen media gevonden";
$pgv_lang["media_privacy"]			= "Wegens Privacy beperkingen kunt u dit bestand niet bekijken";
...
$pgv_lang["button_alive_in_year"] 	= "Toon personen, levend in het aangegeven jaar.";
$pgv_lang["button_BIRT_Y100"] 		= "Toon personen, geboren in de laatste 100 jaar.";
$pgv_lang["button_BIRT_YES"] 		= "Toon personen, geboren meer dan 100 jaar geleden.";
$pgv_lang["button_DEAT_H"] 			= "Toon paren, waarvan alleen de mannelijke partner is overleden.";
$pgv_lang["button_DEAT_N"] 			= "Toon nog levende personen, of paren waarvan beide partners nog leven.";
$pgv_lang["button_DEAT_W"] 			= "Toon paren, waarvan alleen de vrouwelijke partner is overleden.";
$pgv_lang["button_DEAT_Y"] 			= "Toon overleden personen, of paren waarvan beide partners zijn overleden.";
$pgv_lang["button_DEAT_Y100"] 		= "Toon personen, gestorven in de laatste 100 jaar.";
$pgv_lang["button_DEAT_YES"] 		= "Toon personen, gestorven meer dan 100 jaar geleden.";
$pgv_lang["button_MARR_DIV"] 		= "Toon gescheiden paren.";
$pgv_lang["button_MARR_U"] 			= "Toon paren met een onbekende huwelijksdatum.";
$pgv_lang["button_MARR_Y100"] 		= "Toon paren, getrouwd in de laatste 100 jaar.";
$pgv_lang["button_MARR_YES"] 		= "Toon paren, getrouwd meer dan 100 jaar geleden.";
$pgv_lang["button_reset"] 			= "Reset tot de standaard waarden.";
$pgv_lang["button_SEX_F"] 			= "Toon alleen vrouwen.";
$pgv_lang["button_SEX_M"] 			= "Toon alleen mannen.";
$pgv_lang["button_SEX_U"] 			= "Toon alleen personen, waarvan het geslacht onbekend is.";
$pgv_lang["button_TREE_L"] 			= "Toon «tak» paren of personen. Dit zijn nog levende personen, waarvan geen kinderen zijn opgenomen in het bestand.";
$pgv_lang["button_TREE_R"] 			= "Toon «wortel» paren of personen. Deze mensen worden ook wel «patriarchen» genoemd.  Zij zijn personen, waarvan geen ouders zijn pgenomen in het bestand.";
$pgv_lang["sort_column"] 			= "Gebruik deze kolom om te sorteren.";
?>
