...
$pgv_lang["SHOW_NO_WATERMARK"]			= "Hvem kan se ikke-vand mærkeret billeder?";
$pgv_lang["WATERMARK_THUMB"]			= "Tilføj Vandmærke til små billeder?";
$pgv_lang["SAVE_WATERMARK_THUMB"]		= "Gem vand mærker lille billede på server";
$pgv_lang["SAVE_WATERMARK_IMAGE"]		= "Gem vand mærkeret fuld størrelse billede på serrver";
...
$pgv_lang["CHART_BOX_TAGS_help"]		= "~#pgv_lang[CHART_BOX_TAGS]#~<br /><br />Som tillæg til faktaoplysninger om fødsel- og dødsdato vist i Anetræer, kan du her skrive fakta separeret med mellemrum eller komma.  Denne liste kræver at du bruger faktanavnet, som de er beskrevet i GEDCOM 5.5.1 standarden.  For eksempel, hvis du ønsker at vise erhverv i boksene, kan du tilføje \"OCCU\" til feltet.";
...
$pgv_lang["DBTYPE_help"]				= "~#pgv_lang[DBTYPE]#~<br /><br />Forskellige PEAR understøttede databaser, der kan benyttes.  Der kan vælges mellem MySQL, PostgreSQL, Oracle og SQLite.";
$pgv_lang["DBHOST"] 					= "Databasevært";
$pgv_lang["DBHOST_help"] 				= "~#pgv_lang[DBHOST]#~<br /><br />DNS navnet eller IP-adressen på webserveren, hvor din database er installeret.";
$pgv_lang["DBUSER"] 					= "Database brugernavn";
$pgv_lang["DBUSER_help"] 				= "~#pgv_lang[DBUSER]#~<br /><br />Dit brugernavn til databasen. Brugernavnet er nødvendig for at kunne logge ind på din database.";
$pgv_lang["DBPASS"] 					= "Database adgangskode";
$pgv_lang["DBPASS_help"] 				= "~#pgv_lang[DBPASS]#~<br /><br />Din adgangskode til databasen. Adgangskoden er nødvendig for at kunne logge ind på din database.";
$pgv_lang["DBNAME"] 					= "Database navn";
$pgv_lang["DBNAME_help"] 				= "~#pgv_lang[DBNAME]#~<br /><br />Den database på serveren, som du vil have PhpGedView til at bruge.  Det brugernavn du indtastede i brugerfeltet skal have rettigheder til at gemme, overskrive, opdatere, slette og vælge i databasen.";
$pgv_lang["TBLPREFIX_help"] 			= "~#pgv_lang[TBLPREFIX]#~<br /><br />Et præfiks der føjes til de tabeller PhpGedView har oprettet.  Ved at ændre denne værdi kan du sætte flere PhpGedView sider op til at bruge den samme database, men med forskellige tabeller.";
$pgv_lang["ALLOW_CHANGE_GEDCOM_help"]	= "~#pgv_lang[ALLOW_CHANGE_GEDCOM]#~<br /><br />Ved at vælge <b>Ja</b>, giver du brugere af hjemmesiden muligheden for at skifte slægtsdatabase, hvis du har lagt flere slægtsdatabaser ind.<br /><br />Hvis du har valgt <b>Nej</b>, vil brugere ikke have mulighed for at skifte slægtsdatabase.";
...
$pgv_lang["PEDIGREE_SHOW_GENDER"]	= "Vis køn ikon på kort";
...
$pgv_lang["SHOW_AGE_DIFF"]			= "Vis Alders forskel";
...
$pgv_lang["HIDE_LIVE_PEOPLE_help"] 		= "~#pgv_lang[HIDE_LIVE_PEOPLE]#~<br /><br />Denne funktion giver PhpGedView besked om at skjule personlige oplysninger om nulevende personer.  Nulevende personer defineres som personer, for hvem der ikke er registreret begivenheder længere tilbage end for 120 år siden, og som ikke har børn, der er født for mere end 100 år siden.";
...
$pgv_lang["SHOW_MEDIA_DOWNLOAD"]		= "Vis download link i Media viser";
...
$pgv_lang["PGV_SESSION_TIME_help"] 		= "~#pgv_lang[PGV_SESSION_TIME]#~<br /><br />Tid i sekunder før PhpGedView kræver at en bruger, der er logget ind, må logge sig ind igen. Standard er 30 minutter.";
...
$pgv_lang["USE_REGISTRATION_MODULE_help"] = "~#pgv_lang[USE_REGISTRATION_MODULE]#~<br /><br />Giver besøgende mulighed for at registrere sig for at få en konto på hjemmesiden.<br /><br />Ansøgeren vil modtage en e-mail, der indeholder en kode for at bekræfte ansøgningen.<br />Ansøgningen skal godkendes af en administrator før kontoen bliver aktiveret.";
$pgv_lang["ALLOW_USER_THEMES_help"]		= "~#pgv_lang[ALLOW_USER_THEMES]#~<br /><br />Giver brugere mulighed for selv at vælge deres eget tema.";
$pgv_lang["PGV_SIMPLE_MAIL_help"]		= "~#pgv_lang[PGV_SIMPLE_MAIL]#~<br /><br />I den almindelige e-mail header for eksterne e-mails oplyses om e-mail-adresse og navn. Nogle e-mail systemer godtager ikke dette. Ved at vælge \"Ja\", vil kun e-mail-adressen blive brugt.";
...
$pgv_lang["PGV_MEMORY_LIMIT_help"]		= "~#pgv_lang[PGV_MEMORY_LIMIT]#~<br /><br />Det maksimale forbrug af hukommelse, der kan benyttes af PhpGedView scripts.  Standard er 16M.  Mange værter afviser dette valg i deres PHP konfigurationer, så en ændring af denne værdi behøver ikke nødvendigvis betyde noget for, hvor meget den maksimale hukommelse er.";
$pgv_lang["PGV_STORE_MESSAGES_help"]	= "~#pgv_lang[PGV_STORE_MESSAGES]#~<br /><br />Her angives om meddelelser, der er sendt via PhpGedView, kan gemmes i databasen. Hvis du vælger <b>Ja</b>, vil brugere kunne få meddelelserne, når de logger sig ind i på hjemmsiden.  Hvis der vælges <b>Nej</b>, vil meddelelserne kun blive sendt med e-mail.";
$pgv_lang["ALLOW_THEME_DROPDOWN"]		= "Vis felt for at skifte tema";
$pgv_lang["ALLOW_THEME_DROPDOWN_help"]	= "~#pgv_lang[ALLOW_THEME_DROPDOWN]#~<br /><br />Giver brugere mulighed for at vælge deres eget layout (tema) fra en \"drop down\" liste (hvis den er tilgængelig som tema)<br />Det er også nødvendigt at feltet: \"Tillad brugere at vælge deres eget tema\" er sat til <b>Ja</b>.";
$pgv_lang["MAX_VIEW_RATE"]		= "Maksimal hastighed for sidevisning";
$pgv_lang["MAX_VIEW_RATE_help"]	= "~#pgv_lang[MAX_VIEW_RATE]#~<br /><br />Denne valgmulighed sætter en grænse for, hvor hurtigt man kan skifte mellem siderne.<br /><br />Hvis hastigheden overskrides, vil PhpGedView håndtere sessionen som et forsøg på at hacke siten; sessionen vil blive lukket ned med en passende meddelelse.  Disse to værdier burde sætte en rimelig begrænsning på båndbredden og download af bytes fra serveren.  Denne funktion kan slås fra ved at sætte tidsintervallet til 0.";
$pgv_lang["META_AUTHOR"]				= "META tag: Forfatter";
$pgv_lang["META_AUTHOR_help"]			= "~#pgv_lang[META_AUTHOR]#~<br /><br />Her kan du angive navnet på den hovedansvarlige for hjemmesiden, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Hvis feltet er tomt, vil det fulde navn på slægtsdatabasens kontaktperson blive anvendt.";
...
$pgv_lang["META_PUBLISHER_help"]		= "~#pgv_lang[META_PUBLISHER]#~<br /><br />Her kan du angive navnet på udgiveren af hjemmesiden, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Hvis feltet er tomt, vil det fulde navn på slægtsdatabasens kontaktperson blive anvendt.";
...
$pgv_lang["META_COPYRIGHT_help"]		= "~#pgv_lang[META_COPYRIGHT]#~<br /><br />Her kan du angive ophavsretten til hjemmesiden, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Hvis feltet er tomt, vil det fulde navn på slægtsdatabasens kontaktperson blive anvendt.";
...
$pgv_lang["META_DESCRIPTION_help"]		= "~#pgv_lang[META_DESCRIPTION]#~<br /><br />Her kan du indsætte en beskrivelse af hjemmesiden, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Hvis feltet er tomt, vil titlen på den aktive slægtsdatabase blive anvendt.";
...
$pgv_lang["META_PAGE_TOPIC_help"]		= "~#pgv_lang[META_PAGE_TOPIC]#~<br /><br />Her kan du angive et emneord som din hjemmeside hører ind under, og som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Hvis feltet er tomt, vil titlen på den aktive slægtsdatabase blive anvend.";
...
$pgv_lang["META_AUDIENCE_help"]			= "~#pgv_lang[META_AUDIENCE]#~<br /><br />Her kan du angive en målgruppe for hjemmesiden og som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.";
$pgv_lang["META_PAGE_TYPE"]				= "META tag: Side type";
$pgv_lang["META_PAGE_TYPE_help"]		= "~#pgv_lang[META_PAGE_TYPE]#~<br /><br />Her kan du angive typen af siden, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.";
$pgv_lang["META_ROBOTS"]				= "META tag: Robotter";
$pgv_lang["META_ROBOTS_help"]			= "~#pgv_lang[META_ROBOTS]#~<br /><br />Her kan du angive søgerobotter, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Mange søgerobotter checker ikke denne værdi.";
$pgv_lang["META_REVISIT"]				= "META tag: Hvor ofte bør/skal søgerobotter indeksere hjemmesiden";
$pgv_lang["META_REVISIT_help"]			= "~#pgv_lang[META_REVISIT]#~<br /><br />Her kan du angive, hvor ofte du ønsker at hjemmesiden skal opdateres af søgerobotter, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Mange søgerobotter checker ikke denne værdi.";
$pgv_lang["META_KEYWORDS"]				= "META tag: Nøgleord";
$pgv_lang["META_KEYWORDS_help"]			= "~#pgv_lang[META_KEYWORDS]#~<br /><br />Her kan du angive nøgleord, som vil blive indsat i <meta> tagget i begyndelsen af HTML siden.  Mange søgerobotter vil bruge disse nøgleord for at kunne indeksere dine sider.  Som tillæg til det du angiver her, vil de mest anvendte efternavne, der bliver vist i rammen: <b>Statistik</b> på hovedsiden, blive vist.";
$pgv_lang["META_SURNAME_KEYWORDS"]		= "Tilføj de mest anvendte efternavne, som nøgleord i meta tagget";
$pgv_lang["META_SURNAME_KEYWORDS_help"]	= "~#pgv_lang[META_SURNAME_KEYWORDS]#~<br /><br />Hvis du vælger <b>Ja</b> vil efternavnene fra listen:<b> #pgv_lang[common_surnames]#</b> blive føjet til som nøgleord i meta tagget.  Det kan hjælpe søgemaskiner så de lettere kan finde din side.";
$pgv_lang["META_TITLE"]					= "META tag: Undertitel";
$pgv_lang["META_TITLE_help"]			= "~#pgv_lang[META_TITLE]#~<br /><br />Her kan du angive en undertitel som supplement til den almindelige titel i <meta> tagget i begyndelsen af HTML siden.  Undertitlen vil blive indsat efter standardtitlen og før PhpGedView navnet.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "~#pgv_lang[SHOW_LIVING_NAMES]#~<br /><br />Skal navnet på nulevende personer vises til alle?<";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Vis forskningsassistent";
$pgv_lang["USE_RELATIONSHIP_PRIVACY"]	= "Brug privatliv på slægtskab";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "~#pgv_lang[USE_RELATIONSHIP_PRIVACY]#~<br /><br /><b>Nej</b> betyder at godkendte brugere kan se alle oplysninger om nulevende personer.<br />'<b>Ja</b>' betyder at brugere kun kan se privat information om nulevende personer de er i familie med.";
$pgv_lang["MAX_RELATION_PATH_LENGTH"]	= "Maksimal stilængde for slægtskab";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "~#pgv_lang[MAX_RELATION_PATH_LENGTH]#~<br /><br />Hvis <b>#pgv_lang[USE_RELATIONSHIP_PRIVACY]#</b> er aktiv, vil brugere, der er logget ind, kun kunne se og ændre personer indenfor disse trin af graden af slægtskab.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS"]	= "Check ægteskabsrelationer";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "~#pgv_lang[CHECK_MARRIAGE_RELATIONS]#~<br /><br />Check slægtninge for ægteskabsrelationer.";
...
$pgv_lang["ged_filter_description"] = "Søg indstilling tekst";
$pgv_lang["new_gedcom_title"]		= "Slægtsforskning fra [#GEDCOMFILE#]";
$pgv_lang["keep_media_help"]			= "~#pgv_lang[keep_media]#~<br /><br />Skal eksisterende media link beholdes i databasen eller skiftet ud med GEDCOM som bliver uplagt. <b>Nej</b> fjerne eksisterende media fra databasen. <b>Ja</b>Beholder dem. <br /><br />Denne indstillinger kan bruges når du exporter GEDCOM fra phpGedview til en off-line GEDCOM program som ikke kan håndtere embedded media peger godt nok, for derefter at genimporter dem. Under sådan forhold, er media pegeren blivet fjernet fra det GEDCOM program du bruger og du bliver derfor nød til at sætte Media filerne ind igen på de personer, family og kilder efter du har genindlæst GEDCOM filen.<br /><br /><b>Ja</b> fortæller phpgedview at beholde de eksisterende media link så du ikke behøver at genoprette dem efter du har importeret ændringer, men det kræver at dit program lavere de samme person, familie i samme Nr-id som før.<br /><br /><i>Family Tree Maker</i> er et af de programmer som ikke kan klare dette.<i>Legacy</i> ud af mange kan godt.<br />";
$pgv_lang["USE_MEDIA_VIEWER"]			= "Brug mediefremviser";
$pgv_lang["USE_MEDIA_VIEWER_help"]		= "~#pgv_lang[USE_MEDIA_VIEWER]#~<br /><br />Når denne indstilling <b>#pgv_lang[yes]#</b>, ved tryk på billede vil de producer en Media visning side. Denne side viser i detailjer omkring billedet. Hvis du har rigtigheder til det, kan du også rediger i dette.<br /><br /><b>#pgv_lang[no]#</b>, trykning på billede vil producer it fuld størrelse billede i et nyt vindue.<br />";
$pgv_lang["USE_MEDIA_FIREWALL"]			= "Brug Media Firewall";
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />See wiki for beskrivelse på hvordan man bruger Media Firewall <a href=\http://wiki.phpgedview.net/en/index.php?title=Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php?title=Media_Firewall</a><br />";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Media Firewall Rod Mappe";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~#pgv_lang[MEDIA_FIREWALL_ROOTDIR]#~<br /><br />Mappen hvori de beskyttet Media can blive oprettet. #pgv_lang[MEDIA_FIREWALL_ROOTDIR_note]#<br />";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_note"]	= "Når dette felt er tom, <b>#GLOBALS[INDEX_DIRECTORY]#</b> vil mappe blive brugt.";
$pgv_lang["MEDIA_FIREWALL_THUMBS"]			= "Beskyt Lille billede af beskyttet billeder.";
$pgv_lang["SHOW_SPIDER_TAGLINE"]		= "Vis spider tag linier";
