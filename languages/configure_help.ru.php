...
$pgv_lang["CREATE_GENDEX_help"] 	= "Позволить PhpGedView создавать индексные файлы как только закончится импорт GEDCOM файла. Они сохраняются в index-папке.";
