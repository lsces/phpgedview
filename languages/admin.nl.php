...
$pgv_lang["mod_admin_intro"]		= "Onderstaand is de lijst met alle geïnstalleerde modules installed in deze versie van PhpGedView.  Modules worden geïnstalleerd door ze in de <i>modules</i> map te plaatsen.  Hier kunt u het toegansnivo - per GEDCOM - voor elke module instellen.  Als een module tabbladen bevat voor individuele pagina's of menus voor de menubalk, dan kunt u hier ook het toegangsnivo, voor elk item hiervan, instellen.";
...
$pgv_lang["enter_comment"]			= "U kuint hier uw commentaar invoegen.";
...
$pgv_lang["PGV_SMTP_AUTH_PASS"]		= "Eachtwoord";
$pgv_lang["PGV_SMTP_SSL"]			= "Beveiligde verbinding";
$pgv_lang["PGV_SMTP_FROM_NAME"] 	= "Zender naam";
