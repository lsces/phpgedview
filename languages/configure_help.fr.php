 ...
 * @version $Id$
 */
namespace Bitweaver\Phpgedview;$pgv_lang["SHOW_LIST_PLACES"]           = "Afficher les niveaux de lieux sur des listes";
...
$pgv_lang["PGV_SMTP_ACTIVE_help"]       = "~#pgv_lang[PGV_SMTP_ACTIVE]#~<br /><br />Utilisez le protocole SMTP pour envoyer des mail depuis PhpGedView.<br /><br />Cette option nécessite un une connexion à un serveur de mail SMTP.  Si désactivée, PhpGedView utilise le système de mail intégré sur ce serveur.<br />";
$pgv_lang["PGV_SMTP_HOST_help"]         = "~#pgv_lang[PGV_SMTP_HOST]#~<br /><br />Nom du serveur de mail SMTP.  Exemple: <b>smtp.foo.bar.com</b>.<br />";
$pgv_lang["PGV_SMTP_HELO_help"]         = "~#pgv_lang[PGV_SMTP_HELO]#~<br /><br />Nom de domaine d'une adresse e-mail valide pour ce serveur SMTP.<br /><br />Par exemple, si vous avez un compte e-mail tel que <b>votre.nom@abc.xyz.com</b>, entrez <b>abc.xyz.com</b>.<br />";
$pgv_lang["PGV_SMTP_PORT_help"]         = "~#pgv_lang[PGV_SMTP_PORT]#~<br /><br />Port à utiliser sur le serveur SMTP. Il s'agit généralement du port <b>25</b>.<br />";
$pgv_lang["PGV_SMTP_AUTH_help"]         = "~#pgv_lang[PGV_SMTP_AUTH]#~<br /><br />Certains serveurs SMTP demandent une authentification afin d'envoyer un mail. Entrez le login et le mot de passe ci-dessous.<br />";
$pgv_lang["PGV_SMTP_AUTH_USER_help"]    = "~#pgv_lang[PGV_SMTP_AUTH_USER]#~<br /><br />Login requis pour s'authentifier sur le serveur SMTP (si nécessaire).<br />";
$pgv_lang["PGV_SMTP_AUTH_PASS_help"]    = "~#pgv_lang[PGV_SMTP_AUTH_PASS]#~<br /><br />Mot de passe requis pour s'authentifier sur le serveur SMTP (si nécessaire).<br />";
$pgv_lang["PGV_SMTP_SSL_help"]          = "~#pgv_lang[PGV_SMTP_SSL]#~<br /><br />Transport Layer Security (TLS) et Secure Sockets Layer (SSL) sont des protocoles d'encryption des données sur Internet.<br /><br />TLS 1.0, 1.1 et 1.2 sont des développements standardisés de SSL 3.0. TLS 1.0 et SSL 3.1 sont équivalents. Des travaux plus approfondis sur SSL sont effectués sous le nouveau nom TLS.<br /><br />Si votre serveur SMTP requiert les protocoles TLS ou SLL durant la connexion, sélectionnez l'option <b>#pgv_lang[yes]#</b>.<br />";
$pgv_lang["PGV_SMTP_FROM_NAME_help"]    = "~#pgv_lang[PGV_SMTP_FROM_NAME]#~<br /><br />Entrer le nom à utiliser dans le champ &laquo;De:&raquo; des mails provenant de ce site.<br /><br />Par exemple, si votre nom est <b>Pierre Martin</b> et que vous êtes l'administrateur du site <b>Généalogie Martin</b>, vous pouvez entrer quelque chose comme <b>Pierre Martin</b> or <b>Généalogie Martin</b> ou même <b>Pierre Martin, Administrateur de Généalogie Martin</b>. Vous pouvez entrer l'intitulé que vous souhaitez, mais le HTML n'est pas autorisé.<br />";
