...
$pgv_lang["PGV_DATABASE_help"]			= "This tells PhpGedView what type of datastore you want to use for the GEDCOM files you import into the system.  Select 'Index Files' to use index files stored in the index directory, or select 'DB' to use a database like MySQL.";
$pgv_lang["DBTYPE"]						= "Τύπος Βάσης Δεδομένων";
$pgv_lang["DBTYPE_help"]				= "The type of PEAR supported database to connect to.  Options are MySQL, PostgreSQL, Oracle, and SQLite.";
$pgv_lang["DBHOST"]						= "Database Host";
$pgv_lang["DBHOST_help"]				= "The DNS or IP address of the computer hosting your database server.";
$pgv_lang["DBUSER"]						= "Όνομα Χρήστη Βάσης Δεδομένων";
$pgv_lang["DBUSER_help"]				= "The database username required to login to your database.";
$pgv_lang["DBPASS"]						= "Κωδικός Βάσης Δεδομένων";
$pgv_lang["DBPASS_help"]				= "The database password for the user you entered in the Username field.";
$pgv_lang["DBNAME"]						= "Όνομα Βάσης Δεδομένων";
$pgv_lang["DBNAME_help"]				= "The Database in the server you want PhpGedView to use.  The Username you enter in the user field must have create, insert, update, delete, and select privileges on this database.";
...
$pgv_lang["SERVER_URL_help"]						= "If you use https or a different port other than the default, you will need to enter the URL to access your server here.";
...
$pgv_lang["PGV_SESSION_TIME_help"]					= "The time in seconds that a PhpGedView session remains active before requiring a login.  The default is 2 hours.";
...
$pgv_lang["PGV_SIMPLE_MAIL_help"]					= "In normal mailheaders for external mails, email address as well as the name are used. Some mailsystems will not accept this. Set to yes, only the email adress will be used.";
...
$pgv_lang["LOGFILE_CREATE_help"]					= "How often should the program archive log files.";
$pgv_lang["PGV_MEMORY_LIMIT"]						= "Max Memory Limit";
$pgv_lang["PGV_MEMORY_LIMIT_help"]					= "The maximum amount of memory that can be consumed by PhpGedView scripts.  The default is 16M.  Many hosts disable this option in their PHP configuration, so changing this value may not have any actual affect of the maximum memory setting.";
$pgv_lang["PGV_STORE_MESSAGES"]						= "Allow messages to be stored online";
$pgv_lang["PGV_STORE_MESSAGES_help"]				= "Specifies whether messages sent through PhpGedView can be stored in the database.  If set to 'Yes' then users will be able to retrieve their messages when they login to PGV.  If set to 'No' then messages will only be emailed.";
$pgv_lang["ALLOW_THEME_DROPDOWN"]					= "Display Theme Dropdown selector for theme changes";
$pgv_lang["ALLOW_THEME_DROPDOWN_help"]				= "Gives users the option of selecting their own theme.<br />from a drop down menu (if implemented in the theme)<br />Requires ALLOW_USER_THEMES to be true as well.";
$pgv_lang["META_AUTHOR"]							= "Author META tag";
$pgv_lang["META_AUTHOR_help"]						= "The value to place in the author meta tag in the HTML page header.  Leave this field empty to use the GEDCOM contact user's full name for this value.";
...
$pgv_lang["META_PUBLISHER_help"]					= "The value to place in the publisher meta tag in the HTML page header.  Leave this field empty to use the GEDCOM contact user's full name for this value.";
...
$pgv_lang["META_COPYRIGHT_help"]					= "The value to place in the copyright meta tag in the HTML page header.  Leave this field empty to use the GEDCOM contact user's full name for this value.";
...
$pgv_lang["META_DESCRIPTION_help"]					= "The value to place in the description meta tag in the HTML page header.  Leave this field empty to use the currently active GEDCOM's title for this value.";
...
$pgv_lang["META_PAGE_TOPIC_help"]					= "The value to place in the page-topic meta tag in the HTML page header.  Leave this field empty to use the currently active GEDCOM's title for this value.";
...
$pgv_lang["META_AUDIENCE_help"]						= "The value to place in the audience meta tag in the HTML page header.";
$pgv_lang["META_PAGE_TYPE"]							= "Page Type META tag";
$pgv_lang["META_PAGE_TYPE_help"]					= "The value to place in the page-type meta tag in the HTML page header.";
$pgv_lang["META_ROBOTS"]							= "Robots META tag";
$pgv_lang["META_ROBOTS_help"]						= "The value to place in the robots meta tag in the HTML page header.  Many robots or web crawlers do not listen to this value.";
$pgv_lang["META_REVISIT"]							= "How often should crawlers revisit META tag";
$pgv_lang["META_REVISIT_help"]						= "The value to place in the revisit meta tag in the HTML page header.  Many web crawlers do not listen to this value.";
$pgv_lang["META_KEYWORDS"]							= "Keywords META tag";
$pgv_lang["META_KEYWORDS_help"]						= "The value to place in the keywords meta tag in the HTML page header.  Many search engines will use the keywords meta tag to help index your page.  The most common surnames list that appears in the GEDCOM statistics block on your welcome page will be appended to anything you enter here.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]					= "Show living names<br /><br />Should the names of living people be shown to the public.";
$pgv_lang["SHOW_RESEARCH_LOG_help"]					= "Show research log<br /><br />What type of user can view the research log if it is installed.";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]			= "Use relationship privacy<br /><br />A 'No' value means authenticated users can see the details of all living people.<br />A 'Yes' value means users can only see the private information of living people they are related to.";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]			= "Max. relation path length<br /><br />If #pgv_lang[USE_RELATIONSHIP_PRIVACY] is turned on, logged in users will only be able to see and edit individuals within this number of relationship steps.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]			= "Check marriage relations<br /><br />Check related by marriage relationships.";
