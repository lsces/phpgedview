...
// set error reporting
error_reporting( E_ALL ); //E_ERROR | E_WARNING ); //  BIT_PHP_ERROR_REPORTING );
...
define('PGV_PHPGEDVIEW_URL',  'https://myhomecloud.uk/phpgedview');
...
if (!$gBitDb->isValid() || !PGV_ADMIN_USER_EXISTS) {
	...
	if (PGV_USER_CAN_EDIT && is_readable(PHPGEDVIEW_PKG_INDEX_PATH."pgv_changes.php")) {
