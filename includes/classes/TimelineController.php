...
class TimelineControllerRoot extends BaseController {
	...
	public $nonfacts = [ "BAPL", "ENDL", "SLGC", "SLGS", "_TODO", "CHAN" ];
	/**
	* constructor
	*/
	...
	*/
	public function init() {
		...
		$this->pids = !is_array( $this->pids ) ? [] : array_values( $this->pids );
	...
	*/
	...
	public function print_time_fact($event) {
		...
		$yoffset += ( $month / 12 ) * $this->scale;
				$yoffset += ( $day / 30 ) * ( $this->scale / 12 );
