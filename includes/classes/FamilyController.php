...
class FamilyRoot extends BaseController {
	public $user = null;
	public $showLivingHusb = true;
	public $showLivingWife = true;
	public $parents = '';
	public $display = false;
	public $accept_success = false;
	public $show_changes = true;
	public $famrec = '';
	public $link_relation = 0;
	public $title = '';
	public $famid = '';
	public $family = null;
	public $difffam = null;
	...
	*/
	...
	public function init() {
		...
		$this->parents = [ 'HUSB' => $this->family->getHusbId(), 'WIFE' => $this->family->getWifeId() ];
		...
		$this->link_relation = ( empty( $this->parents['HUSB'] ) || empty( $this->parents['WIFE'] ) ) ? 0 : 1;
	}
	...
	public function getFamilyRecord() {
		return $this->famrec;
	}
