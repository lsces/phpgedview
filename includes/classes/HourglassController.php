...
use Bitweaver\Phpgedview\SourceControllerRoot;
 ...
 */
class HourglassControllerRoot extends SourceControllerRoot {
	public $pid = "";
	...
	function init($rootid='', $show_full=1, $generations=3) {
		...
		$this->show_spouse=safe_GET('show_spouse', [ '0', '1' ], '0');
...
/*			case "addfav":
	 ...
	 * @access public
	 * @return integer maxdc Amount of generations the descendency actually goes
	 */
