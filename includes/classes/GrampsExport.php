 ...
 */
	 ...
	 */
	public function create_date($eParent, $dateRec, $level) {
		if (empty($dateRec)) return;
		$date = new GedcomDate(get_gedcom_value("DATE", $level, $dateRec, 0, false));
	 ...
	 */
	public function create_date_value($date) {
	 ...
	 * @param string GEDCOM record $personrec - the record use to get more information about the event(used when the event is being created)
	 * @param int $event - the $event record
	 */
	public function create_event_ref($eParent, $personrec, $event)
	{
	...
	/**
	  ...
	  * @param int $done - whether the method is called from the GrampsExport($done=1) or a sub-class
	  */
		public function create_event($personrec, $event, $eventRec,$done=1) {
		global $factarray;
	 ...
	 */
	public function create_fam_relation($eParent, $personRec, $tag)
	{
	...
	*/
	...
	/**
	  ...
	  *
	  * @param \ $eParent - the parent DOMElement to which the created Note Element is appended
...
//		}
	...
	/**
	  ...
	  */
	public function create_place($eParent, $hlink) {
	...
	/**
	  ...
	  * @param int $done - whether the method is called from the GrampsExport($done=1) or a sub-class
	  */
	public function create_placeobj($place, $hlink,$done=1) {
  ...
  */
	 ...
	 */
	public function create_media($mediaID, $mediaRec, $level = 1) {
		global $file;
	...
	/**
	  ...
	  */
	public function create_sourceref($eParent, $sourcerefRec, $level)
	{
	...
	/**
	  ...
	  * @param int $done - whether the method is called from the GrampsExport($done=1) or a sub-class
	  */
	public function create_source($sourceID, $sourceRec, $level = 1, $done=1) {
	...
	*/
	public function query_dom($query) {
	...
	*
	*/
	public function validate($domObj, $printXML = true) {
		if ($printXML) {
