 ...
 */
  ...
  protected function SendmailSend($header, $body) {
	$sendmail = ( $this->Sender != '' )
		? sprintf( "%s -oi -f %s -t", escapeshellcmd( $this->Sendmail ), escapeshellarg( $this->Sender ) )
		: sprintf( "%s -oi -t", escapeshellcmd( $this->Sendmail ) );
  ...
  protected function SmtpSend($header, $body) {
    ...
    if(!$this->smtp->Mail($smtp_from)) {
		$from_user = ( strstr( $PGV_SMTP_AUTH_USER, "@" ) !== false ) ? $PGV_SMTP_AUTH_USER : $PGV_SMTP_AUTH_USER . '@' . $PGV_SMTP_HELO;
  ...
  * @todo Should this not be using __set() magic function?
  ...
  public function DKIM_Sign($s) {
	...
	$privKey = ( $this->DKIM_passphrase != '' ) ? openssl_pkey_get_private( $privKeyStr, $this->DKIM_passphrase ) : $privKeyStr;
