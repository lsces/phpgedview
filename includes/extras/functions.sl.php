...
////////////////////////////////////////////////////////////////////////////////
// Localise a number of people. Lokalizacija �tevila oseb. //Glej  lifespan.php
////////////////////////////////////////////////////////////////////////////////
...
function fact_AKA_localisation_sl(&$fact, &$pid) {
	...
	$sex = $person->getSex();
	if ($fact == "_INTE") {
		if ($sex == "M")      $factarray[$fact] = "Pokopan"; // mo�ki
		else if ($sex == "F") $factarray[$fact] = "Pokopana"; // �enska
	}
	else {
		if ($sex == "M")      $factarray[$fact] = "Znan tudi kot"; // mo�ki
		else if ($sex == "F") $factarray[$fact] = "Znana tudi kot "; // �enska
	}
}
///////////////////////////////////////////////////////////////////////////////////////////
...
function fact_NMR_localisation_sl($fact, &$fid) {
	...
	$wife = $family->getWife();
	if ($fact == "_NMR") {
		if (empty($wife) && !empty($husb))	$factarray[$fact] = "Samski"; // mo�ki
		else if (empty($husb) && !empty($wife))	$factarray[$fact] = "Samska"; // �enska
	}
	else if ($fact == "_NMAR") {
		if (empty($wife) && !empty($husb))	$factarray[$fact] = "Nikoli poro�en"; // mo�ki
		else if (empty($husb) && !empty($wife))	$factarray[$fact] = "Nikoli poro�ena"; // �enska
	}
}


////////////////////////////////////////////////////////////////////////////////
// Localise the relationships. Lokalizacja pokrewie�stwa.
////////////////////////////////////////////////////////////////////////////////
