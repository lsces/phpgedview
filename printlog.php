...
if ($auth) {
	// Read the file
	$lines=file(PHPGEDVIEW_PKG_INDEX_PATH  . $logfile);
	...
	if (($logtype == "syslog") || ($logtype == "gedlog")) {
		echo "<tr><td colspan=\"3\" class=\"topbottombar\">", $pgv_lang["logfile_content"], " [", getLRM(), PHPGEDVIEW_PKG_INDEX_PATH , $logfile, "]</td></tr>";
	...
	if ($logtype == "searchlog") {
		echo "<tr><td colspan=\"6\" class=\"topbottombar\">", $pgv_lang["logfile_content"], " [", getLRM(), PHPGEDVIEW_PKG_INDEX_PATH , $logfile, "]</td></tr>";
